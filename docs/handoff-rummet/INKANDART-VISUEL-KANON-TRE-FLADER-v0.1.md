...
**v0.6 · 30. august 2026 · Haruki (K7: walk-in-prisen frigivet, Stevens kendelse 30/8). v0.5 · 29. august 2026. Ratificeret af Steven 29/8 (interim-billedreglen i K5, prisreglen i K7, billedtekst-afløseren i K5(b), email-afmeldingen i K8 og walk-in-omtale-præciseringen i K7).**
...
| K7 | **Prisreglen (Stevens kendelse 29/8 — afløser den gamle ét-tal-regel).** *Et tal må kun stå på fladen, hvis kunden kan betale det i samme øjeblik uden at tale med en artist.* **Må stå:** depositum (100 kr, husets ét-tal), gavekort, merch og prints. **Må ALDRIG stå:** sessionspriser, timepriser, pris pr. værk på Væggen, «fra»-priser, prislister pr. artist — prisen aftales med artisten. **Walk-in må omtales på alle flader, og walk-in-prisen (900 kr) er FRIGIVET** (Stevens kendelser 29/8 + 30/8: «Der må godt stå om walk in på site» · «Det er fint den er frigivet») — den må stå online på husets flader og i Shopify-butikken. Walk-in-tilbuddet er dermed prisreglens tredje tilladte tal ved siden af depositum og gavekort. Skiltet under et værk bærer identitet (titel · artist · år), ikke pris. Mangler et tilladt tal, udelades linjen — `[TAL BEKRÆFTES]` er byggepladsens sprog og går aldrig live. |
