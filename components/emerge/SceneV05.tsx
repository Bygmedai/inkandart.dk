...
<section data-screen-label="Under gaden" style={{position:'relative',zIndex:'5',height:'148svh',background:'linear-gradient(180deg,#120d0b 0%,#0d0a09 32%,#080606 100%)'}}>
  <img src="/emerge/v05/edge-top.svg" alt="" style={{position:'absolute',top:'-2px',left:'0',width:'100%',height:'clamp(150px,27svh,330px)',objectFit:'fill',display:'block',zIndex:'3',pointerEvents:'none'}}/>
  <div data-depth="0.34" style={{position:'absolute',left:'-3vw',top:'4%',width:'30vw',height:'100%',opacity:'.85',zIndex:'2'}}><img src="/emerge/v05/edge-side.svg" alt="" style={{width:'100%',height:'100%',objectFit:'fill',display:'block'}}/></div>
  <div data-depth="0.36" style={{position:'absolute',right:'-3vw',top:'4%',width:'30vw',height:'100%',opacity:'.85',zIndex:'2'}}><img src="/emerge/v05/edge-side.svg" alt="" style={{width:'100%',height:'100%',objectFit:'fill',display:'block',transform:'scaleX(-1)'}}/></div>
  <div data-depth="0.12" style={{position:'absolute',left:'20vw',top:'26%',width:'min(60vw,720px)',opacity:'.07',zIndex:'1'}}><img src="/emerge/v05/ouroboros.svg" alt="" style={{width:'100%',display:'block',filter:'blur(3px)'}}/></div>
  <div data-depth="0.15" style={{position:'absolute',left:'6%',top:'14%',width:'40vw',zIndex:'1'}}><img src="/emerge/v05/smoke.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(6deg)'}}/></div>
  <div data-depth="0.18" style={{position:'absolute',right:'2%',top:'56%',width:'44vw',opacity:'.8',zIndex:'1'}}><img src="/emerge/v05/smoke.svg" alt="" style={{width:'100%',display:'block',transform:'scaleX(-1) rotate(-5deg)'}}/></div>
  <div data-depth="0.14" style={{position:'absolute',left:'48%',top:'80%',width:'220px',opacity:'.1',zIndex:'1'}}><img src="/emerge/v05/smoke-blob.svg" alt="" style={{width:'100%',display:'block',filter:'blur(2px)'}}/></div>
  ...
  <div data-depth="1.1" style={{position:'absolute',left:'70.6%',top:'1%',width:'13px',zIndex:'5'}}><div style={{animation:'fall 6s linear infinite'}}><img src="/emerge/v05/drop-red.svg" alt="" style={{width:'100%',display:'block'}}/></div></div>
  <div data-depth="1.2" style={{position:'absolute',left:'71.2%',top:'3%',width:'9px',zIndex:'5'}}><div style={{animation:'fall 8s linear infinite -3.4s'}}><img src="/emerge/v05/drop-red.svg" alt="" style={{width:'100%',display:'block'}}/></div></div>
  <div data-depth="0.6" style={{position:'absolute',left:'64%',top:'20%',width:'200px',zIndex:'4'}}><img src="/emerge/v05/splat-red.svg" alt="" style={{width:'100%',display:'block'}}/></div>

  <div data-depth="0.44" style={{position:'absolute',left:'21%',top:'-1.5%',width:'clamp(110px,13vw,180px)',zIndex:'4'}}><img src="/emerge/v05/rose.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(174deg)',filter:'saturate(1.1) drop-shadow(0 18px 30px rgba(0,0,0,.6))'}}/></div>
  <div data-depth="0.4" style={{position:'absolute',right:'25%',top:'0.5%',width:'clamp(70px,8vw,115px)',zIndex:'4'}}><img src="/emerge/v05/rose.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(187deg)',filter:'drop-shadow(0 14px 24px rgba(0,0,0,.55))'}}/></div>
  <div data-depth="0.48" style={{position:'absolute',left:'-4%',top:'36%',width:'110%',opacity:'.7',zIndex:'4'}}><img src="/emerge/v05/wire.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(2.6deg)'}}/></div>
  ...
  <div data-depth="0.9" style={{position:'absolute',right:'6%',top:'39%',width:'clamp(160px,18vw,260px)',zIndex:'7'}}><img src="/emerge/v05/snake.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(142deg)',filter:'saturate(1.1) drop-shadow(0 20px 34px rgba(0,0,0,.7))'}}/></div>
  <div data-depth="1.0" style={{position:'absolute',left:'0',top:'44%',width:'100%',zIndex:'7',pointerEvents:'none'}}><div style={{width:'clamp(70px,8vw,110px)',animation:'fly 26s linear infinite -9s'}}><img src="/emerge/v05/swallow.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(-5deg)',filter:'drop-shadow(0 12px 20px rgba(0,0,0,.7))'}}/></div></div>
  <div data-depth="0.85" style={{position:'absolute',left:'5%',top:'53%',width:'clamp(100px,12vw,160px)',zIndex:'7'}}><img src="/emerge/v05/machine.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(12deg)',filter:'drop-shadow(0 18px 30px rgba(0,0,0,.7))'}}/></div>
  <div data-depth="1.05" style={{position:'absolute',left:'78%',top:'58%',width:'clamp(80px,9vw,125px)',zIndex:'7'}}><img src="/emerge/v05/dagger.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(168deg)',filter:'drop-shadow(0 18px 30px rgba(0,0,0,.7))'}}/></div>
  <div data-depth="0.7" style={{position:'absolute',left:'12%',top:'86%',width:'clamp(110px,13vw,170px)',zIndex:'5'}}><img src="/emerge/v05/skull.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(-24deg)',filter:'drop-shadow(0 16px 26px rgba(0,0,0,.6))'}}/></div>
  <div data-depth="0.95" style={{position:'absolute',left:'30%',top:'64%',width:'56px',zIndex:'7'}}><img src="/emerge/v05/cup.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(94deg)'}}/></div>
  <div data-depth="0.8" style={{position:'absolute',left:'32%',top:'66.5%',width:'130px',opacity:'.85',zIndex:'6'}}><img src="/emerge/v05/splat-black.svg" alt="" style={{width:'100%',display:'block'}}/></div>
  <div data-depth="1.1" style={{position:'absolute',left:'52%',top:'88%',width:'44px',zIndex:'7'}}><img src="/emerge/v05/dice.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(32deg)'}}/></div>
  <div data-depth="1.15" style={{position:'absolute',left:'56%',top:'89.5%',width:'34px',zIndex:'7'}}><img src="/emerge/v05/dice.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(-50deg)'}}/></div>
  <div data-depth="1.0" style={{position:'absolute',left:'7%',top:'28%',width:'clamp(46px,5vw,66px)',zIndex:'7'}}><img src="/emerge/v05/rat.svg" alt="" style={{width:'100%',display:'block',filter:'drop-shadow(0 8px 14px rgba(0,0,0,.7))'}}/></div>
  <div data-depth="1.12" style={{position:'absolute',right:'17%',top:'84%',width:'clamp(52px,6vw,76px)',zIndex:'7'}}><img src="/emerge/v05/rat.svg" alt="" style={{width:'100%',display:'block',transform:'scaleX(-1)',filter:'drop-shadow(0 8px 14px rgba(0,0,0,.7))'}}/></div>
  <div data-depth="0.92" style={{position:'absolute',right:'5%',top:'66%',width:'clamp(70px,8vw,110px)',zIndex:'7'}}><img src="/emerge/v05/bottle.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(14deg)',filter:'drop-shadow(0 8px 16px rgba(0,0,0,.7))'}}/></div>
  <div data-depth="1.18" style={{position:'absolute',left:'44%',top:'31%',width:'clamp(26px,2.6vw,38px)',zIndex:'7'}}><img src="/emerge/v05/cigarette.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(-12deg)'}}/></div>

  <div data-depth="0.9" style={{position:'absolute',left:'16%',top:'36%',width:'18px',zIndex:'6'}}><img src="/emerge/v05/spark.svg" alt="" style={{width:'100%',display:'block',animation:'twk 5.2s ease-in-out infinite -1.2s'}}/></div>
  <div data-depth="1.2" style={{position:'absolute',left:'84%',top:'26%',width:'14px',zIndex:'6'}}><img src="/emerge/v05/spark.svg" alt="" style={{width:'100%',display:'block',animation:'twk 4.4s ease-in-out infinite -2.8s'}}/></div>
  <div data-depth="1.05" style={{position:'absolute',left:'38%',top:'80%',width:'16px',zIndex:'6'}}><img src="/emerge/v05/spark.svg" alt="" style={{width:'100%',display:'block',animation:'twk 6.2s ease-in-out infinite'}}/></div>
  <div data-depth="1.25" style={{position:'absolute',left:'24%',top:'10%',width:'12px',zIndex:'8'}}><div style={{animation:'fall 9.5s linear infinite -4s'}}><img src="/emerge/v05/drop-dark.svg" alt="" style={{width:'100%',display:'block'}}/></div></div>
  <div data-depth="1.3" style={{position:'absolute',left:'58%',top:'8%',width:'10px',zIndex:'8'}}><div style={{animation:'fall 11s linear infinite -6s'}}><img src="/emerge/v05/drop-dark.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(6deg)'}}/></div></div>
  <div data-depth="1.15" style={{position:'absolute',left:'10%',top:'68%',width:'10px',zIndex:'8'}}><div style={{animation:'floatUp 17s linear infinite -5s'}}><img src="/emerge/v05/ember.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(30deg)'}}/></div></div>
  <div data-depth="1.35" style={{position:'absolute',left:'68%',top:'74%',width:'9px',zIndex:'8'}}><div style={{animation:'floatUp 15s linear infinite -10s'}}><img src="/emerge/v05/ember.svg" alt="" style={{width:'100%',display:'block'}}/></div></div>
  ...
  <div data-depth="0.7" style={{position:'absolute',left:'38%',bottom:'-4%',width:'190px',opacity:'.85',zIndex:'10'}}><img src="/emerge/v05/splat-black.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(40deg)'}}/></div>
  <div data-depth="1.1" style={{position:'absolute',left:'64%',bottom:'-2%',width:'14px',zIndex:'10'}}><div style={{animation:'fall 10s linear infinite -3s'}}><img src="/emerge/v05/drop-dark.svg" alt="" style={{width:'100%',display:'block'}}/></div></div>
</section>
...
<section id="work" data-screen-label="Work" style={{position:'relative',zIndex:'4',height:'180svh',background:'linear-gradient(180deg,#050404 0%,#0b0808 26%,#0d0908 62%,#070505 100%)'}}>
  <div data-depth="0.32" style={{position:'absolute',left:'-4vw',top:'-2%',width:'26vw',height:'102%',opacity:'.8',zIndex:'2'}}><img src="/emerge/v05/edge-side.svg" alt="" style={{width:'100%',height:'100%',objectFit:'fill',display:'block'}}/></div>
  <div data-depth="0.34" style={{position:'absolute',right:'-4vw',top:'-2%',width:'26vw',height:'102%',opacity:'.8',zIndex:'2'}}><img src="/emerge/v05/edge-side.svg" alt="" style={{width:'100%',height:'100%',objectFit:'fill',display:'block',transform:'scaleX(-1)'}}/></div>
  <div data-depth="0.1" style={{position:'absolute',left:'24vw',top:'34%',width:'min(56vw,680px)',opacity:'.06',zIndex:'1'}}><img src="/emerge/v05/ouroboros.svg" alt="" style={{width:'100%',display:'block',filter:'blur(3px)'}}/></div>
  <div data-depth="0.14" style={{position:'absolute',left:'2%',top:'2%',width:'42vw',zIndex:'1'}}><img src="/emerge/v05/smoke.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(-6deg)'}}/></div>
  <div data-depth="0.16" style={{position:'absolute',right:'0',top:'38%',width:'40vw',opacity:'.8',zIndex:'1'}}><img src="/emerge/v05/smoke.svg" alt="" style={{width:'100%',display:'block',transform:'scaleX(-1) rotate(4deg)'}}/></div>
  <div data-depth="0.12" style={{position:'absolute',left:'20%',top:'74%',width:'46vw',opacity:'.7',zIndex:'1'}}><img src="/emerge/v05/smoke.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(3deg)'}}/></div>
  ...
  <div data-depth="0.85" style={{position:'absolute',left:'52%',top:'5%',width:'40px',zIndex:'9'}}><img src="/emerge/v05/cup.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(-8deg)'}}/></div>
  <div data-depth="1.2" style={{position:'absolute',left:'56%',top:'3%',width:'12px',zIndex:'10'}}><div style={{animation:'fall 9s linear infinite -1.5s'}}><img src="/emerge/v05/drop-red.svg" alt="" style={{width:'100%',display:'block'}}/></div></div>

  <div data-depth="0.3" style={{position:'absolute',right:'22%',top:'33%',width:'min(20%,260px)',opacity:'.35',zIndex:'3'}}><img src="/mood/echo.jpg" alt="" style={{width:'100%',display:'block',filter:'blur(1.5px) saturate(.55) contrast(1.1) brightness(.6) sepia(.16) hue-rotate(-6deg)',maskImage:'url(\'/emerge/v05/mask-b.svg\')',WebkitMaskImage:'url(\'/emerge/v05/mask-b.svg\')',maskSize:'100% 100%',WebkitMaskSize:'100% 100%'}}/></div>
  ...
  <div data-depth="0.75" style={{position:'absolute',left:'8%',top:'2.5%',width:'min(30%,420px)',zIndex:'6'}}>
    <figure style={{margin:'0',transform:'rotate(-2.5deg)'}}>
      <img src="/work/odin.jpg" alt="Black and grey — Odin" style={{width:'100%',display:'block',filter:'saturate(.7) contrast(1.15) brightness(.9) sepia(.14) hue-rotate(-6deg)',maskImage:'url(\'/emerge/v05/mask-b.svg\')',WebkitMaskImage:'url(\'/emerge/v05/mask-b.svg\')',maskSize:'100% 100%',WebkitMaskSize:'100% 100%'}}/>
  ...
  <div data-depth="0.95" style={{position:'absolute',left:'30%',top:'13%',width:'170px',zIndex:'9'}}><img src="/emerge/v05/splat-black.svg" alt="" style={{width:'100%',display:'block'}}/></div>
  <div data-depth="1.0" style={{position:'absolute',left:'5%',top:'1%',width:'clamp(70px,8vw,110px)',zIndex:'9'}}><img src="/emerge/v05/rose.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(22deg)',filter:'drop-shadow(0 14px 24px rgba(0,0,0,.7))'}}/></div>
  ...
  <div data-depth="0.55" style={{position:'absolute',right:'10%',top:'7.5%',width:'min(22%,300px)',zIndex:'3'}}>
    <figure style={{margin:'0',transform:'rotate(2deg)'}}>
      <img src="/work/traditional.jpg" alt="Heart and dagger" style={{width:'100%',display:'block',filter:'saturate(.65) contrast(1.12) brightness(.8) sepia(.14) hue-rotate(-6deg)',maskImage:'url(\'/emerge/v05/mask-c.svg\')',WebkitMaskImage:'url(\'/emerge/v05/mask-c.svg\')',maskSize:'100% 100%',WebkitMaskSize:'100% 100%'}}/>
  ...
  <div data-depth="0.9" style={{position:'absolute',right:'8%',top:'5.5%',width:'clamp(56px,6vw,88px)',zIndex:'9'}}><img src="/emerge/v05/dagger.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(-16deg)',filter:'drop-shadow(0 14px 24px rgba(0,0,0,.7))'}}/></div>

  <div data-depth="0.48" style={{position:'absolute',left:'-4%',top:'23%',width:'110%',opacity:'.7',zIndex:'5'}}><img src="/emerge/v05/wire.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(-2deg)'}}/></div>
  ...
  <div data-depth="0.9" style={{position:'absolute',left:'34%',top:'25%',width:'min(26%,360px)',zIndex:'8'}}>
    <figure style={{margin:'0',transform:'rotate(1.5deg)'}}>
      <img src="/work/godspeed.jpg" alt="Cheetahs — fine line" style={{width:'100%',display:'block',filter:'saturate(.7) contrast(1.15) brightness(.95) sepia(.14) hue-rotate(-6deg)',maskImage:'url(\'/emerge/v05/mask-a.svg\')',WebkitMaskImage:'url(\'/emerge/v05/mask-a.svg\')',maskSize:'100% 100%',WebkitMaskSize:'100% 100%'}}/>
  ...
  <div data-depth="1.15" style={{position:'absolute',left:'32%',top:'38%',width:'16px',zIndex:'9'}}><div style={{animation:'fall 8.5s linear infinite -2s'}}><img src="/emerge/v05/drop-red.svg" alt="" style={{width:'100%',display:'block'}}/></div></div>
  ...
  <div data-depth="0.5" style={{position:'absolute',left:'12%',top:'43%',width:'min(20%,280px)',zIndex:'3'}}>
    <figure style={{margin:'0',transform:'rotate(-3deg)'}}>
      <img src="/work/signetring.jpg" alt="A mark on the hand" style={{width:'100%',display:'block',filter:'saturate(.65) contrast(1.12) brightness(.78) sepia(.14) hue-rotate(-6deg)',maskImage:'url(\'/emerge/v05/mask-b.svg\')',WebkitMaskImage:'url(\'/emerge/v05/mask-b.svg\')',maskSize:'100% 100%',WebkitMaskSize:'100% 100%'}}/>
  ...
  <div data-depth="0.8" style={{position:'absolute',left:'9%',top:'41%',width:'clamp(90px,10vw,140px)',zIndex:'7'}}><img src="/emerge/v05/snake.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(118deg)',filter:'drop-shadow(0 16px 26px rgba(0,0,0,.7))'}}/></div>
  ...
  <div data-depth="0.95" style={{position:'absolute',right:'6%',top:'48%',width:'min(32%,460px)',zIndex:'8'}}>
    <figure style={{margin:'0',transform:'rotate(2.2deg)'}}>
      <img src="/work/saint.jpg" alt="Fresh blackwork" style={{width:'100%',display:'block',filter:'saturate(.7) contrast(1.15) brightness(.95) sepia(.14) hue-rotate(-6deg)',maskImage:'url(\'/emerge/v05/mask-c.svg\')',WebkitMaskImage:'url(\'/emerge/v05/mask-c.svg\')',maskSize:'100% 100%',WebkitMaskSize:'100% 100%'}}/>
  ...
  <div data-depth="1.1" style={{position:'absolute',right:'32%',top:'46%',width:'170px',opacity:'.85',zIndex:'9'}}><img src="/emerge/v05/splat-red.svg" alt="" style={{width:'100%',display:'block'}}/></div>
  <div data-depth="1.05" style={{position:'absolute',right:'10%',top:'63%',width:'44px',zIndex:'9'}}><img src="/emerge/v05/cup.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(-6deg)'}}/></div>
  <div data-depth="1.12" style={{position:'absolute',right:'13%',top:'64%',width:'34px',zIndex:'9'}}><img src="/emerge/v05/cup.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(10deg)'}}/></div>

  <div data-depth="0.65" style={{position:'absolute',left:'30%',top:'63%',width:'min(28%,400px)',zIndex:'4'}}>
    <figure style={{margin:'0',transform:'rotate(-1.5deg)'}}>
      <img src="/work/session.jpg" alt="Under the needle" style={{width:'100%',display:'block',filter:'saturate(.7) contrast(1.15) brightness(.85) sepia(.14) hue-rotate(-6deg)',maskImage:'url(\'/emerge/v05/mask-a.svg\')',WebkitMaskImage:'url(\'/emerge/v05/mask-a.svg\')',maskSize:'100% 100%',WebkitMaskSize:'100% 100%'}}/>
  ...
  <div data-depth="1.0" style={{position:'absolute',left:'26%',top:'60%',width:'clamp(90px,10vw,150px)',zIndex:'9'}}><img src="/emerge/v05/machine.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(-20deg)',filter:'drop-shadow(0 18px 30px rgba(0,0,0,.75))'}}/></div>

  <div data-depth="0.7" style={{position:'absolute',left:'56%',top:'80%',width:'min(24%,340px)',zIndex:'5'}}>
    <figure style={{margin:'0',transform:'rotate(-2deg)'}}>
      <img src="/studio/gade.jpg" alt="Larsbjørnsstræde" style={{width:'100%',display:'block',filter:'saturate(.7) contrast(1.15) brightness(.88) sepia(.14) hue-rotate(-6deg)',maskImage:'url(\'/emerge/v05/mask-b.svg\')',WebkitMaskImage:'url(\'/emerge/v05/mask-b.svg\')',maskSize:'100% 100%',WebkitMaskSize:'100% 100%'}}/>
  ...
  <div data-depth="1.05" style={{position:'absolute',left:'52%',top:'88%',width:'clamp(56px,6.5vw,90px)',zIndex:'9'}}><img src="/emerge/v05/bird-mor.svg" alt="" style={{width:'100%',display:'block',transform:'scaleX(-1)',filter:'drop-shadow(0 10px 20px rgba(0,0,0,.7))'}}/></div>
  <div data-depth="1.15" style={{position:'absolute',left:'30%',top:'93%',width:'clamp(46px,5vw,68px)',zIndex:'9'}}><img src="/emerge/v05/rat.svg" alt="" style={{width:'100%',display:'block',filter:'drop-shadow(0 8px 14px rgba(0,0,0,.7))'}}/></div>

  <div data-depth="0.45" style={{position:'absolute',left:'68%',top:'4%',width:'clamp(60px,7vw,100px)',opacity:'.85',zIndex:'3'}}><img src="/emerge/v05/skull.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(12deg)'}}/></div>
  <div data-depth="1.2" style={{position:'absolute',left:'60%',top:'40%',width:'clamp(40px,4.5vw,60px)',zIndex:'10'}}><img src="/emerge/v05/skull.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(-14deg)',filter:'drop-shadow(0 12px 20px rgba(0,0,0,.7))'}}/></div>
  <div data-depth="1.0" style={{position:'absolute',left:'0',top:'56%',width:'100%',zIndex:'10',pointerEvents:'none'}}><div style={{width:'clamp(60px,7vw,100px)',animation:'flyBack 32s linear infinite -12s'}}><img src="/emerge/v05/swallow.svg" alt="" style={{width:'100%',display:'block',transform:'scaleX(-1) rotate(4deg)',filter:'drop-shadow(0 12px 20px rgba(0,0,0,.7))'}}/></div></div>
  <div data-depth="0.88" style={{position:'absolute',left:'74%',top:'74%',width:'40px',zIndex:'9'}}><img src="/emerge/v05/dice.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(24deg)'}}/></div>
  <div data-depth="0.92" style={{position:'absolute',left:'16%',top:'79%',width:'clamp(60px,7vw,96px)',zIndex:'9'}}><img src="/emerge/v05/bottle.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(6deg)',filter:'drop-shadow(0 8px 16px rgba(0,0,0,.7))'}}/></div>

  <div data-depth="0.9" style={{position:'absolute',left:'22%',top:'34%',width:'18px',zIndex:'9'}}><img src="/emerge/v05/spark.svg" alt="" style={{width:'100%',display:'block',animation:'twk 5.6s ease-in-out infinite -1.6s'}}/></div>
  <div data-depth="1.2" style={{position:'absolute',left:'80%',top:'30%',width:'13px',zIndex:'9'}}><img src="/emerge/v05/spark.svg" alt="" style={{width:'100%',display:'block',animation:'twk 4.6s ease-in-out infinite'}}/></div>
  <div data-depth="1.05" style={{position:'absolute',left:'48%',top:'54%',width:'15px',zIndex:'9'}}><img src="/emerge/v05/spark.svg" alt="" style={{width:'100%',display:'block',animation:'twk 6.4s ease-in-out infinite -3s'}}/></div>
  <div data-depth="0.95" style={{position:'absolute',left:'8%',top:'70%',width:'16px',zIndex:'9'}}><img src="/emerge/v05/spark.svg" alt="" style={{width:'100%',display:'block',animation:'twk 5s ease-in-out infinite -2.2s'}}/></div>
  <div data-depth="1.25" style={{position:'absolute',left:'44%',top:'2%',width:'12px',zIndex:'10'}}><div style={{animation:'fall 10s linear infinite -4.5s'}}><img src="/emerge/v05/drop-dark.svg" alt="" style={{width:'100%',display:'block'}}/></div></div>
  <div data-depth="1.3" style={{position:'absolute',left:'70%',top:'24%',width:'10px',zIndex:'10'}}><div style={{animation:'fall 12s linear infinite -7s'}}><img src="/emerge/v05/drop-dark.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(6deg)'}}/></div></div>
  <div data-depth="1.1" style={{position:'absolute',left:'14%',top:'26%',width:'10px',zIndex:'10'}}><div style={{animation:'floatUp 16s linear infinite -6s'}}><img src="/emerge/v05/ember.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(50deg)'}}/></div></div>
  <div data-depth="1.3" style={{position:'absolute',left:'64%',top:'70%',width:'9px',zIndex:'10'}}><div style={{animation:'floatUp 14s linear infinite -9s'}}><img src="/emerge/v05/ember.svg" alt="" style={{width:'100%',display:'block'}}/></div></div>
  ...
  <div data-depth="0.8" style={{position:'absolute',left:'60%',bottom:'-3%',width:'160px',opacity:'.85',zIndex:'12'}}><img src="/emerge/v05/splat-black.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(-30deg)'}}/></div>
</section>
...
<section id="artist" data-screen-label="Artist" style={{position:'relative',zIndex:'3',height:'105svh',background:'linear-gradient(180deg,#040303 0%,#0a0708 40%,#0b0808 70%,#050404 100%)'}}>
  <div data-depth="0.3" style={{position:'absolute',left:'-5vw',top:'0',width:'24vw',height:'100%',opacity:'.7',zIndex:'2'}}><img src="/emerge/v05/edge-side.svg" alt="" style={{width:'100%',height:'100%',objectFit:'fill',display:'block'}}/></div>
  <div data-depth="0.32" style={{position:'absolute',right:'-5vw',top:'0',width:'24vw',height:'100%',opacity:'.7',zIndex:'2'}}><img src="/emerge/v05/edge-side.svg" alt="" style={{width:'100%',height:'100%',objectFit:'fill',display:'block',transform:'scaleX(-1)'}}/></div>
  <div data-depth="0.12" style={{position:'absolute',left:'4%',top:'8%',width:'44vw',zIndex:'1'}}><img src="/emerge/v05/smoke.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(5deg)'}}/></div>
  <div data-depth="0.16" style={{position:'absolute',right:'0',top:'52%',width:'42vw',opacity:'.8',zIndex:'1'}}><img src="/emerge/v05/smoke.svg" alt="" style={{width:'100%',display:'block',transform:'scaleX(-1) rotate(-6deg)'}}/></div>
  ...
  <div data-depth="0.35" style={{position:'absolute',left:'24%',top:'12%',width:'min(44%,560px)',opacity:'.16',zIndex:'3'}}><img src="/emerge/v05/ouroboros.svg" alt="" style={{width:'100%',display:'block'}}/></div>
  <div data-depth="0.7" style={{position:'absolute',left:'31%',top:'20%',width:'min(26%,340px)',zIndex:'5'}}>
    <figure style={{margin:'0'}}>
      <img src="/artists/nizar/portrait.jpg" alt="Nizar" style={{width:'100%',display:'block',filter:'saturate(.55) contrast(1.12) brightness(.88) sepia(.16) hue-rotate(-6deg)',maskImage:'radial-gradient(120% 105% at 50% 40%, #000 52%, transparent 92%)',WebkitMaskImage:'radial-gradient(120% 105% at 50% 40%, #000 52%, transparent 92%)'}}/>
    </figure>
  </div>
  <div data-depth="0.55" style={{position:'absolute',left:'53%',top:'34%',width:'min(34%,440px)',zIndex:'6'}}>
    <div style={{position:'absolute',left:'-8%',top:'-24%',width:'70%',opacity:'.5',zIndex:'-1'}}><img src="/emerge/v05/splat-red.svg" alt="" style={{width:'100%',display:'block'}}/></div>
  ...
  <div data-depth="0.95" style={{position:'absolute',left:'22%',top:'13%',width:'clamp(90px,10vw,150px)',zIndex:'7'}}><img src="/emerge/v05/machine.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(-18deg)',filter:'drop-shadow(0 18px 30px rgba(0,0,0,.75))'}}/></div>
  <div data-depth="1.0" style={{position:'absolute',right:'14%',top:'55%',width:'clamp(160px,19vw,300px)',zIndex:'7'}}><img src="/emerge/v05/needle.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(8deg)',filter:'drop-shadow(0 16px 26px rgba(0,0,0,.7))'}}/></div>
  <div data-depth="0.9" style={{position:'absolute',left:'26%',top:'58%',width:'46px',zIndex:'7'}}><img src="/emerge/v05/cup.svg" alt="" style={{width:'100%',display:'block'}}/></div>
  <div data-depth="0.94" style={{position:'absolute',left:'29.5%',top:'59%',width:'36px',zIndex:'7'}}><img src="/emerge/v05/cup.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(8deg)'}}/></div>
  <div data-depth="0.98" style={{position:'absolute',left:'32.5%',top:'58.4%',width:'28px',zIndex:'7'}}><img src="/emerge/v05/cup.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(-10deg)'}}/></div>
  <div data-depth="0.45" style={{position:'absolute',right:'22%',top:'10%',width:'clamp(80px,9vw,130px)',zIndex:'4'}}><img src="/emerge/v05/rose.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(178deg)',filter:'drop-shadow(0 14px 24px rgba(0,0,0,.6))'}}/></div>
  <div data-depth="1.1" style={{position:'absolute',left:'12%',top:'38%',width:'clamp(54px,6vw,84px)',zIndex:'8'}}><img src="/emerge/v05/dagger.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(30deg)',filter:'drop-shadow(0 14px 24px rgba(0,0,0,.7))'}}/></div>
  <div data-depth="1.05" style={{position:'absolute',right:'8%',top:'26%',width:'clamp(44px,5vw,68px)',zIndex:'8'}}><img src="/emerge/v05/skull.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(16deg)',filter:'drop-shadow(0 12px 20px rgba(0,0,0,.7))'}}/></div>
  <div data-depth="1.12" style={{position:'absolute',left:'64%',top:'74%',width:'clamp(48px,5.5vw,72px)',zIndex:'8'}}><img src="/emerge/v05/rat.svg" alt="" style={{width:'100%',display:'block',transform:'scaleX(-1)',filter:'drop-shadow(0 8px 14px rgba(0,0,0,.7))'}}/></div>
  <div data-depth="0.85" style={{position:'absolute',left:'0',top:'66%',width:'100%',zIndex:'7',pointerEvents:'none'}}><div style={{width:'clamp(56px,6.5vw,90px)',animation:'fly 29s linear infinite -14s'}}><img src="/emerge/v05/swallow.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(-5deg)',filter:'drop-shadow(0 10px 18px rgba(0,0,0,.7))'}}/></div></div>

  <div data-depth="0.92" style={{position:'absolute',left:'18%',top:'24%',width:'16px',zIndex:'7'}}><img src="/emerge/v05/spark.svg" alt="" style={{width:'100%',display:'block',animation:'twk 5.4s ease-in-out infinite -2s'}}/></div>
  <div data-depth="1.15" style={{position:'absolute',left:'78%',top:'44%',width:'13px',zIndex:'8'}}><img src="/emerge/v05/spark.svg" alt="" style={{width:'100%',display:'block',animation:'twk 4.8s ease-in-out infinite -1s'}}/></div>
  <div data-depth="1.0" style={{position:'absolute',left:'44%',top:'76%',width:'15px',zIndex:'8'}}><img src="/emerge/v05/spark.svg" alt="" style={{width:'100%',display:'block',animation:'twk 6s ease-in-out infinite -3.4s'}}/></div>
  <div data-depth="1.25" style={{position:'absolute',left:'36%',top:'4%',width:'12px',zIndex:'8'}}><div style={{animation:'fall 9.5s linear infinite -3s'}}><img src="/emerge/v05/drop-dark.svg" alt="" style={{width:'100%',display:'block'}}/></div></div>
  <div data-depth="1.3" style={{position:'absolute',left:'68%',top:'6%',width:'10px',zIndex:'8'}}><div style={{animation:'fall 11.5s linear infinite -6.5s'}}><img src="/emerge/v05/drop-red.svg" alt="" style={{width:'100%',display:'block'}}/></div></div>
  <div data-depth="1.2" style={{position:'absolute',left:'10%',top:'74%',width:'10px',zIndex:'8'}}><div style={{animation:'floatUp 15s linear infinite -4s'}}><img src="/emerge/v05/ember.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(20deg)'}}/></div></div>
  <div data-depth="0.6" style={{position:'absolute',left:'38%',top:'74%',width:'clamp(100px,12vw,160px)',zIndex:'5'}}><img src="/emerge/v05/skull.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(-22deg)',filter:'drop-shadow(0 14px 24px rgba(0,0,0,.6))'}}/></div>
  <div data-depth="0.9" style={{position:'absolute',left:'48%',top:'82%',width:'170px',opacity:'.85',zIndex:'6'}}><img src="/emerge/v05/splat-black.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(24deg)'}}/></div>
  <div data-depth="0.5" style={{position:'absolute',left:'-4%',top:'78%',width:'70%',opacity:'.6',zIndex:'4'}}><img src="/emerge/v05/wire.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(4deg)'}}/></div>
  <div data-depth="1.05" style={{position:'absolute',right:'26%',top:'78%',width:'clamp(60px,7vw,100px)',zIndex:'7'}}><img src="/emerge/v05/snake.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(64deg)',filter:'drop-shadow(0 12px 20px rgba(0,0,0,.7))'}}/></div>
  <div data-depth="0.95" style={{position:'absolute',left:'18%',top:'84%',width:'42px',zIndex:'7'}}><img src="/emerge/v05/dice.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(-28deg)'}}/></div>
  <div data-depth="1.1" style={{position:'absolute',right:'12%',top:'86%',width:'120px',opacity:'.7',zIndex:'7'}}><img src="/emerge/v05/splat-red.svg" alt="" style={{width:'100%',display:'block'}}/></div>
  <div data-depth="1.15" style={{position:'absolute',left:'72%',top:'90%',width:'clamp(26px,2.6vw,36px)',zIndex:'7'}}><img src="/emerge/v05/cigarette.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(-6deg)'}}/></div>
...
<section id="booking" data-screen-label="Booking" style={{position:'relative',zIndex:'2',height:'110svh',background:'linear-gradient(180deg,#050404 0%,#070505 45%,#030303 100%)'}}>
  <div data-depth="0.3" style={{position:'absolute',left:'-7vw',top:'0',width:'22vw',height:'96%',opacity:'.6',zIndex:'2'}}><img src="/emerge/v05/edge-side.svg" alt="" style={{width:'100%',height:'100%',objectFit:'fill',display:'block'}}/></div>
  <div data-depth="0.32" style={{position:'absolute',right:'-7vw',top:'0',width:'22vw',height:'96%',opacity:'.6',zIndex:'2'}}><img src="/emerge/v05/edge-side.svg" alt="" style={{width:'100%',height:'100%',objectFit:'fill',display:'block',transform:'scaleX(-1)'}}/></div>
  <div data-depth="0.14" style={{position:'absolute',left:'8%',top:'14%',width:'40vw',zIndex:'1'}}><img src="/emerge/v05/smoke.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(-5deg)'}}/></div>
  <div data-depth="0.16" style={{position:'absolute',right:'2%',top:'44%',width:'38vw',opacity:'.8',zIndex:'1'}}><img src="/emerge/v05/smoke.svg" alt="" style={{width:'100%',display:'block',transform:'scaleX(-1) rotate(6deg)'}}/></div>

  <div data-depth="0.35" style={{position:'absolute',left:'50%',top:'16%',width:'min(46%,520px)',marginLeft:'min(-23%,-260px)',opacity:'.2',zIndex:'3'}}><img src="/emerge/v05/ouroboros.svg" alt="" style={{width:'100%',display:'block'}}/></div>
  ...
  <div data-depth="1.1" style={{position:'absolute',left:'16%',top:'22%',width:'clamp(60px,7vw,100px)',zIndex:'8'}}><img src="/emerge/v05/dagger.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(-20deg)',filter:'drop-shadow(0 16px 26px rgba(0,0,0,.75))'}}/></div>
  <div data-depth="0.45" style={{position:'absolute',right:'14%',top:'8%',width:'clamp(90px,10vw,140px)',zIndex:'4'}}><img src="/emerge/v05/rose.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(184deg)',filter:'drop-shadow(0 14px 24px rgba(0,0,0,.6))'}}/></div>
  <div data-depth="0.9" style={{position:'absolute',right:'20%',top:'38%',width:'clamp(80px,9vw,130px)',zIndex:'7'}}><img src="/emerge/v05/machine.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(14deg)',filter:'drop-shadow(0 14px 24px rgba(0,0,0,.7))'}}/></div>
  <div data-depth="1.05" style={{position:'absolute',left:'24%',top:'58%',width:'clamp(70px,8vw,110px)',zIndex:'8'}}><img src="/emerge/v05/snake.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(-38deg)',filter:'drop-shadow(0 12px 20px rgba(0,0,0,.7))'}}/></div>
  <div data-depth="0.95" style={{position:'absolute',left:'70%',top:'64%',width:'clamp(52px,6vw,80px)',zIndex:'7'}}><img src="/emerge/v05/skull.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(10deg)',filter:'drop-shadow(0 12px 20px rgba(0,0,0,.7))'}}/></div>
  <div data-depth="0.85" style={{position:'absolute',left:'0',top:'52%',width:'100%',zIndex:'7',pointerEvents:'none'}}><div style={{width:'clamp(50px,6vw,84px)',animation:'flyBack 36s linear infinite -8s'}}><img src="/emerge/v05/swallow.svg" alt="" style={{width:'100%',display:'block',transform:'scaleX(-1) rotate(5deg)',filter:'drop-shadow(0 10px 18px rgba(0,0,0,.7))'}}/></div></div>
  <div data-depth="1.12" style={{position:'absolute',left:'60%',top:'80%',width:'clamp(50px,5.5vw,74px)',zIndex:'8'}}><img src="/emerge/v05/bird-mor.svg" alt="" style={{width:'100%',display:'block',filter:'drop-shadow(0 8px 16px rgba(0,0,0,.7))'}}/></div>
  <div data-depth="1.08" style={{position:'absolute',left:'32%',top:'83%',width:'clamp(44px,5vw,64px)',zIndex:'8'}}><img src="/emerge/v05/rat.svg" alt="" style={{width:'100%',display:'block',transform:'scaleX(-1)',filter:'drop-shadow(0 8px 14px rgba(0,0,0,.7))'}}/></div>
  <div data-depth="0.9" style={{position:'absolute',left:'14%',top:'80%',width:'120px',opacity:'.7',zIndex:'7'}}><img src="/emerge/v05/splat-red.svg" alt="" style={{width:'100%',display:'block'}}/></div>
  <div data-depth="1.25" style={{position:'absolute',left:'40%',top:'6%',width:'13px',zIndex:'9'}}><div style={{animation:'fall 9s linear infinite -2s'}}><img src="/emerge/v05/drop-dark.svg" alt="" style={{width:'100%',display:'block'}}/></div></div>
  <div data-depth="1.3" style={{position:'absolute',left:'58%',top:'4%',width:'10px',zIndex:'9'}}><div style={{animation:'fall 11s linear infinite -5.5s'}}><img src="/emerge/v05/drop-red.svg" alt="" style={{width:'100%',display:'block'}}/></div></div>
  <div data-depth="1.0" style={{position:'absolute',left:'22%',top:'36%',width:'15px',zIndex:'8'}}><img src="/emerge/v05/spark.svg" alt="" style={{width:'100%',display:'block',animation:'twk 5.8s ease-in-out infinite -1.4s'}}/></div>
  <div data-depth="1.18" style={{position:'absolute',left:'80%',top:'26%',width:'12px',zIndex:'8'}}><img src="/emerge/v05/spark.svg" alt="" style={{width:'100%',display:'block',animation:'twk 4.4s ease-in-out infinite -2.6s'}}/></div>
  <div data-depth="1.15" style={{position:'absolute',left:'48%',top:'70%',width:'9px',zIndex:'9'}}><div style={{animation:'floatUp 16s linear infinite -6s'}}><img src="/emerge/v05/ember.svg" alt="" style={{width:'100%',display:'block',transform:'rotate(30deg)'}}/></div></div>
