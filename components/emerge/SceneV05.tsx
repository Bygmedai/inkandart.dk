...
<header data-header="" style={{position:'fixed',top:'0',left:'0',right:'0',zIndex:'9980',display:'flex',alignItems:'center',justifyContent:'space-between',gap:'16px',padding:'13px 5vw',background:'rgba(8,7,7,.86)',backdropFilter:'blur(10px)',WebkitBackdropFilter:'blur(10px)',borderBottom:'1px solid rgba(232,224,213,.09)',transform:'translateY(-110%)',opacity:'0',transition:'transform .7s cubic-bezier(.16,1,.3,1),opacity .5s ease'}}>
  ...
  <nav style={{display:'flex',alignItems:'center',gap:'clamp(14px,2.6vw,36px)'}}>
    <a href="#work" style={{borderBottom:'1px solid transparent',fontFamily:'\'Space Mono\',monospace',fontSize:'10px',letterSpacing:'.28em',textTransform:'uppercase',color:'rgba(232,224,213,.72)'}}>{nav.work}</a>
    <a href="#artists" style={{borderBottom:'1px solid transparent',fontFamily:'\'Space Mono\',monospace',fontSize:'10px',letterSpacing:'.28em',textTransform:'uppercase',color:'rgba(232,224,213,.72)'}}>{nav.artist}</a>
    <a href={L("/gavekort")} style={{borderBottom:'1px solid transparent',fontFamily:'\'Space Mono\',monospace',fontSize:'10px',letterSpacing:'.28em',textTransform:'uppercase',color:'rgba(232,224,213,.72)'}}>{nav.gift}</a>
    <a href="https://inkart.book.dk" style={{borderBottom:'1px solid rgba(201,162,39,.5)',fontFamily:'\'Space Mono\',monospace',fontSize:'10px',letterSpacing:'.28em',textTransform:'uppercase',color:'#c9a227',whiteSpace:'nowrap'}}>{nav.booking}</a>
...
<section id="emerge" data-screen-label={c.screens.hero} style={{position:'relative',height:'100svh',zIndex:'6'}}>
  ...
  <p style={{position:'absolute',bottom:'clamp(120px,19svh,220px)',left:'50%',transform:'translateX(-50%)',zIndex:'16',margin:'0',fontFamily:'\'Space Mono\',monospace',fontSize:'clamp(9px,1vw,12px)',letterSpacing:'.6em',textTransform:'uppercase',color:'rgba(232,224,213,.3)',whiteSpace:'nowrap'}}>{c.scroll}</p>
</section>
...
<section id="work" data-screen-label={c.screens.work} style={{position:'relative',zIndex:'4',height:'180svh',background:'linear-gradient(180deg,#050404 0%,#0b0808 26%,#0d0908 62%,#070505 100%)'}}>
  ...
  <div className="v5m-street" data-depth="0.7" style={{position:'absolute',left:'56%',top:'80%',width:'min(24%,340px)',zIndex:'5'}}>
    <figure style={{margin:'0',transform:'rotate(-2deg)'}}>
      ...
      <figcaption style={{marginTop:'12px',fontFamily:'\'Space Mono\',monospace',fontSize:'9.5px',letterSpacing:'.3em',textTransform:'uppercase',color:'#8e867b'}}>{c.gadeCaption}</figcaption>
    </figure>
  </div>
...
<section id="booking" data-screen-label={c.screens.booking} style={{position:'relative',zIndex:'2',height:'128svh',background:'linear-gradient(180deg,#050404 0%,#070505 45%,#030303 100%)'}}>
  ...
  <div className="v5m-book-center" data-depth="0.6" data-drift="0" style={{position:'relative',zIndex:'6',paddingTop:'22svh',textAlign:'center'}}>
    ...
    <div style={{marginTop:'clamp(28px,5svh,56px)'}}>
      <a href="https://inkart.book.dk" style={{fontFamily:'\'Space Mono\',monospace',fontSize:'13px',letterSpacing:'.34em',textTransform:'uppercase',color:'#c9a227',borderBottom:'1px solid rgba(201,162,39,.45)',paddingBottom:'6px'}}>{nav.booking}</a>
      <p style={{margin:'28px 0 0',fontFamily:'\'Space Mono\',monospace',fontSize:'10px',letterSpacing:'.26em',textTransform:'uppercase',color:'#8e867b'}}>Larsbjørnsstræde 13 · 1454 København K · <a href="tel:+4555248608" aria-label={c.callAria(site.phone)} style={{color:'inherit',borderBottom:'1px solid rgba(232,224,213,.25)'}}>55 24 86 08</a></p>
      <p style={{margin:'12px 0 0',fontFamily:'\'Space Mono\',monospace',fontSize:'10px',letterSpacing:'.26em',textTransform:'uppercase',color:'rgba(139,30,30,.85)'}}>{c.findUs}</p>
      <p style={{margin:'26px 0 0',display:'flex',gap:'24px',justifyContent:'center',flexWrap:'wrap'}}>
        <a href={L("/flash")} style={{fontFamily:'\'Space Mono\',monospace',fontSize:'11px',letterSpacing:'.3em',textTransform:'uppercase',color:'rgba(232,224,213,.72)',borderBottom:'1px solid rgba(201,162,39,.35)',paddingBottom:'5px'}}>{c.flash}</a>
      </p>
      <BlackbookSignup />
    </div>
  </div>
  ...
  <footer data-drift="0" style={{position:'absolute',left:'0',right:'0',bottom:'0',zIndex:'10',display:'flex',flexWrap:'wrap',justifyContent:'space-between',gap:'12px',padding:'0 5vw 26px',fontFamily:'\'Space Mono\',monospace',fontSize:'9.5px',letterSpacing:'.2em',textTransform:'uppercase',color:'rgba(232,224,213,.4)'}}>
    ...
    <span style={{display:'flex',gap:'18px'}}>
      <a href={L("/blackbook")} style={{color:'rgba(232,224,213,.4)',borderBottom:'1px solid rgba(201,162,39,.35)'}}>Blackbook</a>
